...
const SUPABASE_URL = getEnvVar('REACT_APP_SUPABASE_URL', 'https://qqoijujnfdyjozhggnvl.supabase.co');
const SUPABASE_ANON_KEY = getEnvVar('REACT_APP_SUPABASE_ANON_KEY', 'sb_publishable_zdDqn--ME7tCeoKoNvFW2g_Oft9bYa8');
